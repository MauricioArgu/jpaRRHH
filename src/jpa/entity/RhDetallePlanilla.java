...
@NamedQueries({
    ...
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnId", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnId = :detPlnId")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnTotal", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnTotal = :detPlnTotal")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnTotalDescuentos", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnTotalDescuentos = :detPlnTotalDescuentos")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnRenta", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnRenta = :detPlnRenta")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnIsss", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnIsss = :detPlnIsss")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnAfp", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnAfp = :detPlnAfp")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnCantidadHorasDiurnas", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnCantidadHorasDiurnas = :detPlnCantidadHorasDiurnas")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnBonoHorasExtra", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnBonoHorasExtra = :detPlnBonoHorasExtra")
    , @NamedQuery(name = "RhDetallePlanilla.findByDetPlnCantidadHorasNocturnas", query = "SELECT r FROM RhDetallePlanilla r WHERE r.detPlnCantidadHorasNocturnas = :detPlnCantidadHorasNocturnas")})
public class RhDetallePlanilla implements Serializable {
    ...
    public String toString() {
        return "prueba.entity.RhDetallePlanilla[ detPlnId=" + detPlnId + " ]";
    }
